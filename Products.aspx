...
<form id="form1" runat="server">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="Products.aspx" class="active"><span>Products</span></a>
    ...
    <div class="main-wrapper" id="mainWrapper">
        ...
        <div class="content-body">
            <div class="page-header">
                <h1>Record Purchase Transaction</h1>
                <p>Manage incoming inventory and supplier procurement records.</p>
            </div>
            <!-- Purchase Form -->
            <div class="form-container">
                ...
                <div class="form-actions">
                    <asp:Button ID="btnSave" runat="server" Text="Record Purchase" CssClass="btn-save" OnClick="btnSave_Click" />
            ...
            <div class="grid-container">
                <asp:GridView ID="gvPurchases" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Rate" HeaderText="Rate/Unit" DataFormatString="₹ {0:N2}" />
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                ...
                                <asp:Button runat="server" Text="Delete" CommandName="DeleteRow"
                                    ...
                                    OnClientClick="return confirm('Remove this record?');" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
